...
@media ( min-width : 768px) {
	...
	.carousel-inner .carousel-item.active:not (.carousel-item-right ):not (.carousel-item-left
		...
		(.carousel-item-left ) +.carousel-item, .carousel-inner .carousel-item.active:not
		(.carousel-item-right ):not (.carousel-item-left ) +.carousel-item+.carousel-item,
		.carousel-inner .carousel-item.active:not (.carousel-item-right ):not
		(.carousel-item-left ) +.carousel-item+.carousel-item+.carousel-item {
		transition: none;
	}
	...
	<div class="container-fluid">
		...
		<header class="text-center">
			<h4 class="text-uppercase">
				<small>Connecting Urban farmers with the local market.</small>
			</h4>
			<h2>Our Featured Picks</h2>
			<!--@@ fore through inventory item.lastUpdated -->
		</header>
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner row w-100 mx-auto">
				...
				<div class="carousel-item col-md-3">
					<div class="card">
						<img class="card-img-top img-fluid"
							src="https://images.unsplash.com/photo-1556843824-256570ca21c4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80"
							alt="Card image cap">
						<div class="card-body">
				...
				<div class="carousel-item col-md-3">
					<div class="card">
						<img class="card-img-top img-fluid"
							src="https://image.shutterstock.com/z/stock-photo-yellow-golden-raisins-isolated-on-white-background-1064872322.jpg"
							alt="Card image cap">
						<div class="card-body">
				...
				<div class="carousel-item col-md-3">
					<div class="card">
						<img class="card-img-top img-fluid"
							src="https://image.shutterstock.com/z/stock-photo-ripe-peaches-in-basket-on-wooden-background-297863489.jpg"
							alt="Card image cap">
						<div class="card-body">
				...
				<div class="carousel-item col-md-3 active">
					<div class="card">
						<img class="card-img-top img-fluid"
							src="https://image.shutterstock.com/z/stock-photo-pink-lady-apples-isolated-on-white-background-1122706196.jpg"
							alt="Card image cap">
						<div class="card-body">
				...
				<div class="carousel-item col-md-3">
					<div class="card">
						<img class="card-img-top img-fluid"
							src="https://image.shutterstock.com/z/stock-photo-isolated-berries-red-currant-fruits-isolated-on-white-background-137215997.jpg"
							alt="Card image cap">
						<div class="card-body">
				...
				<div class="carousel-item col-md-3">
					<div class="card">
						<img class="card-img-top img-fluid"
							src="https://image.shutterstock.com/z/stock-vector-honeydew-melon-whole-fresh-ripe-sweet-fruit-with-sliced-juicy-piece-of-cut-melon-realistic-fruits-1157387923.jpg"
							alt="Card image cap">
						<div class="card-body">
